...
public class ServletContextSetup implements ServletContainerInitializer {
    ...
    public void onStartup(Set<Class<?>> set, ServletContext sc) throws ServletException {
        ...
        fiber.setInitParameter("javax.ws.rs.Application", "com.bstirbat.message.srv.JerseyApplication");

        // Set packages to be scanned for resources
        fiber.setInitParameter("jersey.config.server.provider.packages", "com.bstirbat.message.srv");
